      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto mb-16">
          <div className="h-[30px] pl-3 pr-3.5 py-1 bg-white rounded-full shadow-[0px_1px_3px_0px_rgba(13,13,18,0.05)] border border-[#dfe1e6] justify-center items-center gap-1.5 inline-flex">
            <Image width={16} height={16} src="/portofolio-logo.png" alt="EVOP Blog Articles Logo" />
            <p className="text-blue-500 text-sm font-sans">EVOP Articles</p>
          </div>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0d0d12]">Latest from Our Blog</h1>
            ...
            <AnimationWrapper key={post.id}>
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <Link href={`/blog/${post.id}`} className="block" title={`Read full article: ${post.title}`}>
