...
export const metadata: Metadata = {
  ...
  description: 'Explore our collection of articles about business, technology, and digital transformation. Get expert insights and tips from EVOP.',
  openGraph: {
    title: 'EVOP Blog - Latest Articles and Insights',
    description: 'Explore our collection of articles about business, technology, and digital transformation. Get expert insights and tips from EVOP.',
    type: 'website',
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <time className="text-sm text-gray-600" dateTime={post.date}>{post.date}</time>
                    <Link
                      href={`/blog/${post.id}`}
