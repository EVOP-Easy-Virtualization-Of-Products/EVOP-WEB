...
export const metadata: Metadata = {
  ...
  description:
    "EVOP Tech is Software Company that serve website or application for your startup, where it has lot of good benefits for the user. We Offering Cyber Security Assistant in other hands..",
  keywords:
    "EVOP TECH, Easy Virtualization Of Products, Software House, Software Company, Startup",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={plusJakartaSans.variable}>
      ...
      <body
        className="font-plus-jakarta text-white min-h-screen"
