        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            ...
            <div className="relative">
              <button 
                className="flex items-center justify-between space-x-2 text-gray-300 bg-gray-600 px-4 py-3 rounded-full" 
                onClick={() => setDropdownOpen(!dropdownOpen)}
                style={{ width: '123px' }} // Menyesuaikan lebar
              >
                <Image
            ...
            <a
              ...
              className="block text-center font-bold w-full bg-[#287eff] text-white px-4 py-3 rounded-full hover:bg-[#287eff]/90 transition-colors"
